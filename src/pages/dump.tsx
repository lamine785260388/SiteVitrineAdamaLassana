...
const Dump: React.FC = () => {
      ...
      <ul className="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
        <li className="nav-item border-dashed active">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#fruits" /></svg>
            <span>Fruits and vegetables</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#dairy" /></svg>
            <span>Dairy and Eggs</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#meat" /></svg>
            <span>Meat and Poultry</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#seafood" /></svg>
            <span>Seafood</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#bakery" /></svg>
            <span>Bakery and Bread</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#canned" /></svg>
            <span>Canned Goods</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#frozen" /></svg>
            <span>Frozen Foods</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#pasta" /></svg>
            <span>Pasta and Rice</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#breakfast" /></svg>
            <span>Breakfast Foods</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#snacks" /></svg>
        ...
        <li className="nav-item border-dashed">
          <button className="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2" data-bs-toggle="collapse" data-bs-target="#beverages-collapse" aria-expanded="false">
            <div className="d-flex gap-3">
              <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#beverages" /></svg>
              <span>Beverages</span>
            </div>
          </button>
        ...
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#spices" /></svg>
            <span>Spices and Seasonings</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#baby" /></svg>
            <span>Baby Food and Formula</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#health" /></svg>
            <span>Health and Wellness</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#household" /></svg>
            <span>Household Supplies</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#personal" /></svg>
            <span>Personal Care</span>
          </a>
        </li>
        <li className="nav-item border-dashed">
          <a href="index.html" className="nav-link d-flex align-items-center gap-3 text-dark p-2">
            <svg width={24} height={24} viewBox="0 0 24 24"><use xlinkHref="#pet" /></svg>
  ...
  <h2 className="display-1 ls-1">
    <span className="fw-bold text-secondary">Propulser</span> l'avenir du ferroviaire et du génie civil<span className="fw-bold"> en Afrique</span>
  </h2>
  <p className="fs-4">
    Expertise et innovation au service des infrastructures ferroviaires, du matériel roulant et du génie civil
    <span className="fw-bold">chez RAIL DYNAMIC AFRICA</span>.
  </p>
  <div className="d-flex gap-3">
...
<p className="card-text">Expertise et ingénierie au service de vos projets VRD et Aménagement.</p>
  ...
  <div className="icon-container">
    ...
    <p className="icon-text">Études Ferroviaires</p>
  </div>
  ...
  <div className="icon-container">
    ...
    <p className="icon-text">VRD Aménagement</p>
  </div>
</div>
