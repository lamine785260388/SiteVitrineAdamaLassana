            ...
            <div className="col-lg-6 pt-5 mt-5">
              ...
              <h6 className="display-1 ls-1 scrolling-text text-dark fw-bold" style={{fontSize:'25px'}}>
                ...
                {language === "Français"
                  ...
                  : " the future of rail and civil engineering"}
                  ...
                  <div className="col-md-9">
                    <div className="card-body p-0">
                      ...
                      <p className="card-text">
                        {language === "Français"
                          ? "Solutions innovantes pour des infrastructures performantes."
                          : "Innovative solutions for high-performance infrastructure."}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-12 d-flex justify-content-around align-items-center">
              ...
              <div className="icon-container">
                <div className="icon-background bg-green">
                  <img
                    src="src/assets/images/hook.png"
                    alt="VRD Aménagement"
                    className="icon"
                    height={100}
                    width={100}
      ...
      <div className="row">
          ...
          <article className="post-item card border-0 shadow-sm p-3">
            ...
            <div className="card-body">
              <div className="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                <div className="meta-date"><svg width={16} height={16}><use xlinkHref="#calendar" /></svg>15 Mars 2024</div>
                <div className="meta-categories"><svg width={16} height={16}><use xlinkHref="#category" /></svg>Innovation</div>
              </div>
              <div className="post-header">
                <h3 className="post-title">
                  <a href="#" className="text-decoration-none">5 Innovations Clés dans les Infrastructures Ferroviaires Africaines</a>
                </h3>
                <p>Découvrez comment les systèmes de signalisation intelligents et les designs modulaires de voies révolutionnent la connectivité continentale. Apprenez comment nous mettons en œuvre des solutions de pointe pour des réseaux durables...</p>
              </div>
            </div>
          </article>
        </div>
        <div className="col-md-4">
          <article className="post-item card border-0 shadow-sm p-3">
            ...
            <div className="card-body">
              <div className="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                <div className="meta-date"><svg width={16} height={16}><use xlinkHref="#calendar" /></svg>22 Mars 2024</div>
                <div className="meta-categories"><svg width={16} height={16}><use xlinkHref="#category" /></svg>Durabilité</div>
              </div>
              <div className="post-header">
                <h3 className="post-title">
                  <a href="#" className="text-decoration-none">Solutions Ferroviaires Écologiques : Réduire l'Empreinte Carbone de l'Afrique</a>
                </h3>
                <p>Explorez nos initiatives de dépôts solaires et nos stratégies d'utilisation de matériaux recyclés. Découvrez comment nous équilibrons développement des infrastructures et respect de l'environnement...</p>
              </div>
            </div>
          </article>
        </div>
        <div className="col-md-4">
          <article className="post-item card border-0 shadow-sm p-3">
            ...
            <div className="card-body">
              <div className="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                <div className="meta-date"><svg width={16} height={16}><use xlinkHref="#calendar" /></svg>29 Mars 2024</div>
                <div className="meta-categories"><svg width={16} height={16}><use xlinkHref="#category" /></svg>Sécurité</div>
              </div>
              <div className="post-header">
                <h3 className="post-title">
                  <a href="#" className="text-decoration-none">Protocoles de Sécurité de Nouvelle Génération pour les Réseaux Ferroviaires Africains</a>
                </h3>
                <p>Découvrez notre approche intégrée combinant des systèmes de surveillance IA et des programmes de formation communautaire pour améliorer la sécurité opérationnelle à travers les corridors continentaux...</p>
              </div>
            </div>
          </article>
        </div>
