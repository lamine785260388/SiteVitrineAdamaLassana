...
const Index: React.FC = () => {
  ...
  <Header />
  <section style={{backgroundImage: 'url("src/assets/images/trainew2.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
      ...
      <div className="row">
        ...
        <div className="col-md-9">
          <div className="card-body p-0">
            ...
            <p className="card-text">
              {language === "Français" ? "Expertise et ingénierie au service de vos projets VRD et Aménagement." : "Expertise and engineering for your civil engineering and development projects."}
            </p>
          </div>
        </div>
      </div>
